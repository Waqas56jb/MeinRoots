export default {
  ...
  detail: {
    ...
    danger: {
      title: 'Diese Kandidatin oder diesen Kandidaten löschen?',
      text: 'Löscht das Konto, das Profil, die Lebenslauf-Dateien und alle abgeleiteten Daten. Nur ein anonymisierter Audit-Eintrag bleibt bestehen. Das lässt sich nicht rückgängig machen.',
      button: 'Endgültig löschen',
      aboutTo: 'Sie löschen endgültig:',
      reference: 'Referenz',
      id: 'Kandidaten-ID',
      noReference: 'Noch keine Referenz — zu diesem Konto gibt es keinen Lebenslauf.',
      removes: 'Damit werden Konto, Profil, Dokumente, Lebenslaufdaten, Bewertungen und Antworten entfernt.',
      irreversible: 'Diese Aktion lässt sich nicht rückgängig machen.',
      done: 'Kandidat gelöscht.',
      superAdminOnly: 'Nur ein Super-Admin kann Kandidaten löschen.',
    },
    sharing: {
    ...
    cleanup: {
      title: 'Kein Lebenslauf hochgeladen',
      text: 'Konten ohne hochgeladenen Lebenslauf werden {{when}} automatisch entfernt.',
      due: 'Vorgesehen für {{date}}',
      overdue: 'Wird beim nächsten Aufräumlauf entfernt',
    },
  },
  ...
  recruiters: {
    title: 'Recruiter',
    subtitle: 'Unternehmen, die über MeinRoots einstellen.',
    searchPlaceholder: 'Unternehmen oder Recruiter suchen…',
    filterVerification: 'Prüfung',
    filterPlan: 'Tarif',
    emptyTitle: 'Noch keine Recruiter',
    emptyText: 'Unternehmen erscheinen hier nach der Registrierung.',
    emptyFiltered: 'Nichts passt zu diesen Filtern',
    emptyFilteredText: 'Entferne einen Filter.',
    pendingTitle: 'Die Recruiter-Verwaltung ist noch nicht aktiv',
    pendingText: 'Tabelle, Filter und Zustände sind fertig. Sie brauchen den Unternehmens-Endpunkt.',
    verification: {
      pending: 'In Prüfung',
      verified: 'Geprüft',
      info_required: 'Angaben nötig',
      rejected: 'Abgelehnt',
    },
    plans: {
      trial: 'Test',
  ...
  adminRequests: {
    ...
    subtitle: 'Jede Anfrage eines Unternehmens an eine Person.',
    filterStatus: 'Status',
    emptyTitle: 'Noch keine Anfragen',
    emptyText: 'Anfragen erscheinen hier, sobald Recruiter sie senden.',
    pendingTitle: 'Die Anfragen-Überwachung ist noch nicht aktiv',
    pendingText: 'Tabelle und Filter sind fertig. Sie brauchen den Anfragen-Endpunkt.',
    types: {
      contact: 'Kontakt',
      interview: 'Interview',
    },
  ...
  subscriptions: {
    title: 'Abos',
    subtitle: 'Tarife, Tests und Abrechnungsstatus.',
    plansTitle: 'Tarifkonfiguration',
    plansHint: 'Vom Server gelesen. Hier steht kein in die Konsole getippter Preis.',
    plansPending: 'Die Tarifkonfiguration ist noch nicht aktiv. Sie braucht',
    plan: 'Tarif',
    price: 'Preis',
    priceNotSet: 'Nicht gesetzt',
    interval: 'Abrechnung',
    trialDays: 'Testtage',
    enabled: 'Aktiv',
    on: 'An',
    ...
    emptyText: 'Abos erscheinen hier, sobald Unternehmen einen Tarif wählen.',
    pendingTitle: 'Die Abo-Überwachung ist noch nicht aktiv',
    pendingText: 'Tabelle und Tarifkonfiguration sind fertig. Sie brauchen die Abo-Endpunkte.',
    intervals: {
      month: 'Monatlich',
      year: 'Jährlich',
    },
