export default {
  ...
  detail: {
    ...
    danger: {
      ...
      text: 'Supprime le compte, le profil, les fichiers de CV et toutes les données dérivées. Seule une entrée d’audit anonymisée subsiste. Cette action est irréversible.',
      button: 'Supprimer définitivement',
      aboutTo: 'Vous êtes sur le point de supprimer définitivement :',
      reference: 'Référence',
      id: 'Identifiant du candidat',
      noReference: 'Pas encore de référence — ce compte n’a aucun CV.',
      removes: 'Cela supprime son compte, son profil, ses documents, ses données de CV, ses évaluations et ses réponses.',
      irreversible: 'Cette action est irréversible.',
      done: 'Candidat supprimé.',
      superAdminOnly: 'Seul un super-administrateur peut supprimer un candidat.',
    },
    sharing: {
    ...
    cleanup: {
      ...
      text: 'Les comptes sans CV sont supprimés automatiquement {{when}}.',
      due: 'Prévu pour {{date}}',
      overdue: 'Sera supprimé lors du prochain nettoyage',
    },
  },
